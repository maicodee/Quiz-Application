...
public class Quiz extends JFrame implements ActionListener {
   String[][] questions = new String[10][5];  // Array to store quiz questions
   String[][] answers = new String[10][2];    // Array to store correct answers
   String[][] useranswers = new String[10][1]; // Array to store user's answers
   JLabel qno;           // Label to display the question number
   JLabel question;      // Label to display the question
   JRadioButton opt1;    // Radio button for option 1
   JRadioButton opt2;    // Radio button for option 2
   JRadioButton opt3;    // Radio button for option 3
   JRadioButton opt4;    // Radio button for option 4
   ButtonGroup groupoptions; // Button group to manage radio buttons
   JButton next;         // Button to go to the next question
   JButton submit;       // Button to submit the quiz
   JButton lifeline;     // Button to use a lifeline
   public static int timer = 15;    // Timer for each question
   public static int ans_given = 0;  // Flag to check if an answer is given
   public static int count = 0;      // Question count
   public static int score = 0;      // Quiz score
   ...
   Quiz(String name) {
      ...
      this.question.setFont(new Font("Tahoma", 0, 24));
